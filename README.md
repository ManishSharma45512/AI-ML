...
![Notebooks Completed](https://img.shields.io/badge/Notebooks%20Completed-<!--NOTEBOOK_COUNT-->6<!--END_NOTEBOOK_COUNT-->-00A4EF?style=for-the-badge&logo=jupyter)
...
| ⚡ Metric | 🎯 Value |
|:---:|:---:|
| **Notebooks / Scripts Completed** | `<!--NOTEBOOK_COUNT-->6<!--END_NOTEBOOK_COUNT-->` 🔵 *(auto-updates on every push)* |
| **Language** | `Python` |
